...
public class AppointService {
    ...
    @Transactional
    public ApiResponse<EmptyResponse> updateAppoint(UpdateAppointRequest request, String updateUser) {
        ...
        try {
            ...
            log.error("異動約訪記錄檔失敗，sno={}, updateUser={}", request.getSno(), updateUser, e);
            return ApiResponse.fail(new EmptyResponse(), "更新失敗");
        }
    }
}
